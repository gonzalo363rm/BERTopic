...
#=========================================
#
# BERTopic_senadores without preprocess
#
#=========================================
...
#     # Lee las líneas
#     senadores = file.read().split('__NUEVO_DOCUMENTO')
...
#                     custom_dataset=custom,
#                     verbose=True)
#     results = trainer.train(save=f"/app/own/results/Basic/senadores/bertopic_{i+1}")
...
for i in range(3):
    trainer = Trainer(dataset=dataset,
                    ...
                    custom_dataset=custom,
                    verbose=True)
    results = trainer.train(save=f"/app/own/results/Basic/senadores_preprocessed/bertopic_{i+1}")